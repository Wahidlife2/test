...
import { Trash2, Plus, Minus, ArrowLeft, Truck, ShieldCheck, RotateCcw, ShoppingBasket } from 'lucide-react';
...
const CartPage = () => {
        ...
        return (
            <div className="cart-empty-state container">
                <div className="empty-content">
                    ...
                    <Link to="/" className="btn-primary-coquesdeluxe">DÉCOUVRIR LES NOUVEAUTÉS</Link>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="cart-page-coquesdeluxe">
                ...
                <div className="cart-grid">
                    ...
                    <div className="cart-sidebar">
                        <div className="summary-box">
                            ...
                            <button className="btn-checkout-coquesdeluxe" onClick={() => navigate('/checkout')}>
                                PASSER LA COMMANDE
                            </button>
            ...
            <style jsx>{`
                .cart-page-coquesdeluxe { background: #fcfcfc; min-height: 100vh; padding-bottom: 100px; font-family: 'Sora', sans-serif; }
                ...
                .step.active { color: #000000; }
                .step-line { width: 40px; height: 1px; background: #eee; }

                .cart-title { font-size: 1.8rem; font-weight: 800; margin-bottom: 32px; color: #000000; }
                ...
                .qty-picker button { background: none; border: none; cursor: pointer; display: flex; align-items: center; color: #000000; }
                .qty-picker button:disabled { opacity: 0.3; }
                .qty-picker span { font-weight: 800; font-size: 0.9rem; min-width: 20px; text-align: center; }
                .current-price-item { font-size: 1.2rem; font-weight: 800; color: #000000; }

                .cart-actions-bottom { padding: 20px 0; }
                .continue-link { display: flex; align-items: center; gap: 8px; font-size: 0.85rem; font-weight: 700; color: #000000; }
                ...
                .summary-row.promo { border-top: 2px solid #000000; padding-top: 16px; margin-top: 8px; }
                .final-total { font-size: 1.5rem; font-weight: 900; color: #000000; }

                .btn-checkout-coquesdeluxe { width: 100%; padding: 18px; background: #000000; color: white; border: none; border-radius: 4px; font-size: 1.05rem; font-weight: 800; cursor: pointer; transition: opacity 0.2s; }
                .btn-checkout-coquesdeluxe:hover { opacity: 0.95; }
                ...
                .btn-primary-coquesdeluxe { padding: 16px 32px; background: #000000; color: white; font-weight: 800; border-radius: 4px; }

...
const Checkout = () => {
    ...
    return (
        <div className="checkout-page-coquesdeluxe">
            {/* Stepper Header */}
                    ...
                    <div className="form-column">
                        {step === 2 && (
                            <div className="checkout-card">
                                ...
                                <form onSubmit={nextStep}>
                                    <div className="form-group-coquesdeluxe">
                                        <label>Adresse e-mail</label>
                                        <input type="email" name="email" required value={formData.email} onChange={handleInputChange} />
                                    </div>
                                    <div className="form-row-coquesdeluxe">
                                        <div className="form-group-coquesdeluxe">
                                            <label>Prénom</label>
                        ...
                        {step === 3 && (
                            <div className="checkout-card">
                                ...
                                <div className="delivery-options-coquesdeluxe">
                        ...
                        {step === 4 && (
                            <div className="checkout-card">
                                ...
                                <div className="payment-options-coquesdeluxe">
            ...
            <style jsx>{`
                .checkout-page-coquesdeluxe { background: #F7F7F7; min-height: 100vh; padding-bottom: 80px; font-family: 'Sora', sans-serif; }
                ...
                .checkout-card h2 { font-size: 1.5rem; font-weight: 800; margin-bottom: 32px; color: #000000; }

                .form-group-coquesdeluxe { margin-bottom: 24px; }
                .form-group-coquesdeluxe label { display: block; font-size: 0.85rem; font-weight: 700; margin-bottom: 8px; color: #444; }
                .form-group-coquesdeluxe input { width: 100%; padding: 14px; border: 1px solid #ddd; border-radius: 4px; font-size: 1rem; font-family: inherit; }
                .form-group-coquesdeluxe input:focus { border-color: #000000; outline: none; }
                
                .form-row-coquesdeluxe { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; }
                
                .btn-next-step, .btn-pay-now { width: 100%; padding: 20px; background: #000000; color: white; border: none; border-radius: 4px; font-size: 1rem; font-weight: 800; cursor: pointer; transition: opacity 0.2s; }
                .btn-next-step:hover, .btn-pay-now:hover { opacity: 0.9; }

                .delivery-options-coquesdeluxe { margin-bottom: 32px; }
                .delivery-method { display: flex; justify-content: space-between; align-items: center; padding: 20px; border: 2px solid #000000; border-radius: 4px; background: #F0F4FF; }
                ...
                .payment-options-coquesdeluxe { margin-bottom: 32px; display: flex; flex-direction: column; gap: 16px; }
                ...
                .payment-choice:has(input:checked) { border-color: #000000; background: #F0F4FF; }
                ...
                .t-row.final { border-top: 2px solid #000000; padding-top: 16px; margin-top: 8px; font-weight: 900; font-size: 1.2rem; color: #000000; }
                ...
                .btn-back-home { padding: 18px 40px; background: #000000; color: white; border: none; border-radius: 40px; font-weight: 800; cursor: pointer; }

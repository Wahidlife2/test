...
const SearchResults = () => {
    ...
    const results = coquesdeluxeProducts.filter(p =>
        p.name.toLowerCase().includes(query.toLowerCase()) ||
        p.category.toLowerCase().includes(query.toLowerCase())
    );

    return (
        <div className="search-page-coquesdeluxe container">
            ...
            <style jsx>{`
                .search-page-coquesdeluxe { padding-top: 40px; padding-bottom: 80px; font-family: 'Sora', sans-serif; }
                ...
                .search-title { font-size: 1.8rem; font-weight: 800; color: #000000; }
                .search-title .count { font-size: 1.1rem; font-weight: 400; color: #757575; margin-left: 12px; }
                
                .filter-btn { display: flex; align-items: center; gap: 10px; padding: 12px 24px; background: white; border: 1px solid #000000; border-radius: 4px; font-weight: 700; color: #000000; cursor: pointer; transition: all 0.2s; }
                .filter-btn:hover { background: #000000; color: white; }
                ...
                .empty-box h2 { font-size: 1.5rem; font-weight: 800; margin-bottom: 16px; color: #000000; }
                .empty-box p { color: #666; margin-bottom: 32px; line-height: 1.6; }
                .btn-back { padding: 16px 32px; background: #000000; color: white; border: none; border-radius: 4px; font-weight: 800; cursor: pointer; }

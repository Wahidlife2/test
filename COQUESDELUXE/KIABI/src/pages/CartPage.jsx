    ...
    return (
        <div className="cart-page-coquesdeluxe">
            ...
            <style jsx>{`
                ...
                .btn-checkout-coquesdeluxe { width: 100%; padding: 18px; background: #000137; color: white; border: none; border-radius: 4px; font-size: 1.05rem; font-weight: 800; cursor: pointer; transition: opacity 0.2s; }
                ...
                .btn-primary-coquesdeluxe { padding: 16px 32px; background: #000137; color: white; font-weight: 800; border-radius: 4px; }

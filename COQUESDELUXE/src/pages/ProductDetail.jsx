...
const ProductDetail = () => {
    ...
    const product = coquesdeluxeProducts.find(p => p.id === parseInt(id));
    ...
    return (
        <div className="pdp-page">
            ...
            <style jsx>{`
                ...
                .brand-badge { background: #000000; color: white; padding: 4px 12px; font-size: 0.7rem; font-weight: 800; border-radius: 2px; }
                .pdp-actions { display: flex; gap: 12px; }
                .icon-btn { background: none; border: none; cursor: pointer; color: #000000; }

                .product-title { font-size: 2rem; font-weight: 800; color: #000000; margin-bottom: 8px; }
                ...
                .current-price { font-size: 2.2rem; font-weight: 800; color: #000000; }
                ...
                .selector-label strong { color: #000000; }
                ...
                .color-btn.active { transform: scale(1.1); border: 2px solid #000000; }
                ...
                .size-dropdown-btn.error { border-color: #000000; background: #FEF2F2; }
                .rotate { transform: rotate(180deg); }
                .error-text { color: #000000; font-size: 0.8rem; font-weight: 700; margin-top: 8px; }
                ...
                .size-btn-opt:hover { border-color: #000000; }
                .size-btn-opt.active { background: #000000; color: white; border-color: #000000; }

                .btn-add-to-cart { width: 100%; padding: 20px; background: #000000; color: white; border: none; border-radius: 4px; font-size: 1.1rem; font-weight: 800; cursor: pointer; margin-top: 32px; transition: background 0.2s; }

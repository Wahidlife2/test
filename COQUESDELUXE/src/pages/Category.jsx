...
const Category = () => {
  ...
  const subCategories = useMemo(() => {
    const subs = coquesdeluxeProducts
  ...
  const products = useMemo(() => {
    let filtered = coquesdeluxeProducts.filter(p => p.category === name);
  ...
  return (
    <div className="category-page-coquesdeluxe container">
      ...
      <style jsx>{`
                .category-page-coquesdeluxe { padding-top: 20px; padding-bottom: 80px; font-family: 'Sora', sans-serif; }
                ...
                .category-title { font-size: 2.2rem; font-weight: 800; color: #000000; }
                
                .sort-container { position: relative; }
                .filter-btn { display: flex; align-items: center; gap: 10px; padding: 12px 24px; background: #F5F5F7; border: none; border-radius: 8px; font-weight: 700; color: #000000; cursor: pointer; transition: all 0.2s; }
                ...
                .sort-option { padding: 14px 20px; cursor: pointer; color: #000000; font-weight: 500; transition: background 0.2s; }
                .sort-option:hover { background: #F5F5F7; color: #000000; }
                ...
                .subcategory-item span { font-size: 0.85rem; font-weight: 700; color: #000000; text-align: center; }
                .subcategory-item.active .subcategory-circle { border: 2px solid #000000; }
                .subcategory-item.active span { color: #000000; }
                ...
                .clear-filter { display: flex; align-items: center; gap: 6px; background: #000000; color: white; border: none; padding: 6px 12px; border-radius: 20px; font-size: 0.75rem; cursor: pointer; font-weight: 600; }
